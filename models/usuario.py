...
MAILGUN_DOMAIN = 'sandboxe8d400e0c34f4e0a89b0ace53d2c0528.mailgun.org'
MAILGUN_API_KEY = 'a3e6847fefb06adf018ec5e4350fa669-162d1f80-52abf9f1'
FROM_TITLE = 'NO-REPLY'
...
class UserModel(banco.Model):
    ...
    def send_confirmation_email(self):
        ...
        link = request.host_url[:-1] + url_for('userconfirm', user_id=self.user_id)
        return post('https://api.mailgun.net/v3/{}/messages'.format(MAILGUN_DOMAIN),
                    ...
                    data={'from': '{} <{}>'.format(FROM_TITLE, FROM_EMAIL),
                          ...
                          'html': '<html><p>\
                            Confirme seu cadastro no link a seguir: <a href="{}">CONFIRMAR EMAIL</a>\
                            </p></html>'.format(link)
                        }
                )
